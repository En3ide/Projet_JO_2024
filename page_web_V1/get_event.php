...
if (isset($_GET['param1'])) {
    ...
    $sql = "SELECT Event.*, Discipline.* FROM Event JOIN Discipline ON Event.id_disc = Discipline.id_disc;";
    $resultat = mysqli_query($connexion, $sql);
}
?>
...
<head>
    ...
    <title>Tableau des épreuves</title>
    <style>
        table {
...
<body>
    ...
    <table class="table_donne">
        <tr>
            ...
            <th>Format de l'épreuve</th>
            <th>Genre de l'épreuve</th>
        </tr>
        ...
        if ($resultat && mysqli_num_rows($resultat) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($resultat)) {
                echo "<tr>";
                echo "<td>" . $row['name_fr_disc'] . "</td>";
                echo "<td>" . $row['name_event'] . "</td>";
                echo "<td>" . $row['format_event'] . "</td>";
                echo "<td>" . $row['gender_event'] . "</td>";
                echo "</tr>";
            }
        } else {
